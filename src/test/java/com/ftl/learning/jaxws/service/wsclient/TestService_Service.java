 ...
 * 
 */
@WebServiceClient(name = "testService", targetNamespace = "http://service.jaxws.learning.ftl.com/", wsdlLocation = "http://localhost:8080/jaxws/testService?wsdl")
public class TestService_Service extends Service {
	...
	static {
		...
		try {
			url = new URL("http://localhost:8080/jaxws/testService?wsdl");
